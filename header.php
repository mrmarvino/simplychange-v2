						...
						<div class="search-content">
							<?php
								if ( is_user_logged_in() ) {
									...
									echo' <a href="'.wp_logout_url( get_permalink() ).'" class="client-login btn">Logout</a>  ';

									} else {
							?>
							<?php bloginfo('description');?>
								<a href="<?php echo home_url('/');?>wp-login.php" class="client-login btn">Client login <i class="icon-chevron-right"></i></a>
							<?php
									}
							?>
						</div>
